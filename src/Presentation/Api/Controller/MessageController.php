...
/*
 * TODO
 * 1. После получения сообщения все файлы и само сообщения удаляются из базы
 * 2. Пользователю отдаются ссылки на скачивание файлов (в ссылку вшит хеш с шифрованными именем, расширением и инфой по скачиваюнию)
 * 3. После скачивания файл удаляется с сервера
 *
 * Хеш для скачивания файла генерировать ГДЕ??? По идее в приложении - и делать dto в приложении для передачи сообщения наружу
 *
 * Сделать возможность скачать все файлы одним архивом??
 *
 * !! rate limiter
 */
